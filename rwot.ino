...
const char *password = "Dopa";

// Authentication
const char *ADMIN_USER = "Ogenrwot";
...
String htmlHeader(const String &title) {
  ...
  h += "button{font-size:16px;padding:10px 20px;margin:6px;border:none;border-radius:5px;cursor:pointer;}";
  h += ".on{background:#28a745;color:white;}";
  h += ".off{background:#dc3545;color:white;}";
  h += ".logout{background:#666;color:white;padding:6px 16px;font-size:14px;margin-top:30px;}";
...
// HTML Footer
String htmlFooter() {
  return "<footer>Group: Logical_Loopers<br>Developed by Ogenrwot Emmanuel</footer></body></html>";
}

// Login Page
String loginPage(const String &msg = "") {
  String html = htmlHeader("Login");
  html += "<h1>Login - Logical_Loopers</h1><div class='container'>";
...
String controlPage() {
  ...
  html += "<h1>Logical_Loopers - Lighting Control</h1><div class='container'>";
  html += "<h3>Main Controls</h3>";
